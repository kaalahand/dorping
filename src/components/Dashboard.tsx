...
Feel free to modify, expand, or adapt this content to better suit your specific needs. You can also use the chat feature to request adjustments or ask questions about the generated content.`;
  ...
  const getCompletedTasks = () => {
    return Object.values(onboardingChecklist).filter(Boolean).length;
  };

  const getTotalTasks = () => {
    return Object.keys(onboardingChecklist).length;
  };
      ...
      <div className={`bg-white border-r border-gray-200 transition-all duration-300 ${sidebarCollapsed ? 'w-20' : 'w-64'} flex flex-col`}>
        ...
        <div className="p-4 border-t border-gray-200 space-y-4">
          ...
          <div className="relative profile-dropdown">
            ...
            {showProfileDropdown && !sidebarCollapsed && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                <div className="py-1">
                  ...
                  <button
                    onClick={() => handleProfileOption('subscription')}
                    className="w-full flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                  >
            ...
            {showProfileDropdown && sidebarCollapsed && (
              <div className="absolute bottom-0 left-full ml-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 w-48">
                <div className="py-1">
                  <button
                    onClick={() => handleProfileOption('profile')}
                    className="w-full flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Compact Onboarding Progress */}
            {showOnboarding && (
              <div className="bg-white rounded-xl shadow-md border border-gray-200 p-4 max-w-xs">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{getCompletedTasks()}/{getTotalTasks()} completed</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-xs ${onboardingChecklist.createPrompt ? 'text-gray-600' : 'text-gray-900 font-medium'}`}>
                      Create First Prompt
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-xs ${onboardingChecklist.savePrompt ? 'text-gray-600' : 'text-gray-900'}`}>
                      Save a Prompt
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-xs ${onboardingChecklist.ratePrompt ? 'text-gray-600' : 'text-gray-900'}`}>
                      Rate Output Quality
                    </span>
                  </div>
                </div>
